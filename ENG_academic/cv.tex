...
%-------------------------------------------------------------------------------
\name{Alexandra Shikunova}{}
\position{Student \& researcher in Linguistics{\enskip\cdotp\enskip} NLP engineer}
\address{HSE University, Staraya Basmannaya Ulitsa 21/4, Moscow, Russia}

%\mobile{+1 000-000-0000}
\email{notalexandrashikunova@email.com}
\homepage{thddbptnsndshs.github.io/academic\_site/}
\github{thddbptnsndshs}
%\linkedin{mylinkedin}
% \gitlab{my-gitlab-id}
...
\makecvfooter
  {Last updated \today}
  {Alexandra Shikunova ~~~·~~~ Curriculum Vitae}
  {\thepage}
