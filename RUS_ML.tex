...
\begin{wrapfigure}{r}{0.25\textwidth} %this figure will be at the right
    \centering
    \includegraphics[width=0.22\textwidth]{photo2}
\end{wrapfigure}
...
\years{2023}\href{https://github.com/thddbptnsndshs/texops}{TeXOps -- простой инструмент для генерации cookie-cutter проектов в LaTeX}\\
...
\years{2021}\href{https://github.com/thddbptnsndshs/idioms}{Анализ данных синтаксического эксперимента с помощью Python} (sklearn)\\
